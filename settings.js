...
global.owner = process.env.OWNER_NUMBER  || '2347041039367' ;  // ADD YOUR NUMBER WITHOUT +
    
module.exports = {
SESSION_ID: process.env.SESSION_ID || 'VAJIRA-MD=OVcGhJYI#O59meRQJrrxjxDphtDIq6fcixR2bqGyXw-wNvG4PnOY' ,
travaSend: process.env.TRAVA_SEND || '25' ,   
MODERATORS : process.env.MODERATORS === undefined ? "2347041039367" : process.env.MODERATORS ,    
